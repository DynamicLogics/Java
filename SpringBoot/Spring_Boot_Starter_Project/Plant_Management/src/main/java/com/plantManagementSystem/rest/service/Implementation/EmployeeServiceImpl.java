...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public String newWorkshopOperations(PlantOperation plantObj) {
		//System.out.println("SSA: "+plantObj.getUserId()+"  "+plantObj.getDepartmentStatus()+"  "+plantObj.getDepartmentName());
		return empDaoServ.setWorkShopOperations(plantObj.getUserId(), plantObj.getDepartmentStatus());
	}
