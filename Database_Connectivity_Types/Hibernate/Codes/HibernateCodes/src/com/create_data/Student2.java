...
public class Student2 {
	...
	@Id
	//with the help of this '@GeneratedValue' annotation we can insert multiple data inside our database
	...
	public String toString() {
		return "Student2 [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", email=" + email + "]";
	}	
